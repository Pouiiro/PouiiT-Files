return {
  ...
  keys = {
    { "<leader>åg", "<cmd>EcologGoto<cr>", desc = "Go to env file" },
    { "<leader>åp", "<cmd>EcologPeek<cr>", desc = "Ecolog peek variable" },
    { "<leader>ås", "<cmd>EcologSelect<cr>", desc = "Switch env file" },
  },

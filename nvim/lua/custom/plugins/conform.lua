  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        yaml = { 'prettier', 'biome-check', 'biome', stop_after_first = true },
        graphql = { 'prettier', 'biome-check', 'biome', stop_after_first = true },
        html = { 'prettier', 'biome-check', 'biome', stop_after_first = true },
        jsonc = { 'prettier', 'biome-check', 'biome', stop_after_first = true },
        markdown = { 'prettier', 'biome-check', 'biome', stop_after_first = true },
        bash = { 'shfmt', 'prettier', 'biome-check', 'biome', stop_after_first = true },
        sh = { 'shfmt', 'prettier', 'biome-check', 'biome', stop_after_first = true },

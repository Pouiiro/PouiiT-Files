...
-- map('n', '<left>', '<cmd>echo "Use h to move!!"<CR>', { desc = 'Disable left arrow' })
-- map('n', '<right>', '<cmd>echo "Use l to move!!"<CR>', { desc = 'Disable right arrow' })
-- map('n', '<up>', '<cmd>echo "Use k to move!!"<CR>', { desc = 'Disable up arrow' })
-- map('n', '<down>', '<cmd>echo "Use j to move!!"<CR>', { desc = 'Disable down arrow' })
...
map('n', '<C-l>', '<cmd>lua main_term_toggle()<cr>', { desc = 'Toggle floating terminal', silent = true })
map('n', '<C-b>', function()
